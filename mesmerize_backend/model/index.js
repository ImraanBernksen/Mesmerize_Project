...
class User {
    login(req, res) {
        ...
        const strQry =
        `
        SELECT firstName, lastName, userGender, userEmail, userPassword, userRole, userImg, DATE_FORMAT(joinDate, '%d-%m-%Y') AS joinDate
        FROM Users
    ...
    fetchUsers(req, res) {
        const strQry =
        `
        SELECT userID, firstName, lastName, userGender, userCellphone, userEmail, userPassword, userRole, userImg, DATE_FORMAT(joinDate, '%d-%m-%Y') AS joinDate
        FROM Users;
        `;
    ...
    fetchUser(req, res) {
        const strQry =
        `
        SELECT userID, firstName, lastName, gender, cellPhone, userEmail, userPassword, userRole, userImg, DATE_FORMAT(joinDate, '%d-%m-%Y') AS joinDate
        FROM Users
        WHERE userID = ?;
        `;
